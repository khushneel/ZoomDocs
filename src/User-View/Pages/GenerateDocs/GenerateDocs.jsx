...
export default function GenerateDocs() {
  ...
  useEffect(() => {
    if (
      ...
      generateDocument(docstype, user_inputs, tone_level, authId, userId)
        .then((res) => {
          ...
          if (res.data && res.data.html && res.data.html.fileName) {
            ...
            getGeneratedDocument("html", htmlFileName, authId, userId)
              .then((htmlRes) => {
                console.log("[GenerateDocs-HTML] Full API response:", htmlRes);
                console.log(
                ...
                if (htmlRes.data instanceof Blob) {
                  htmlRes.data
                    .text()
                    .then((text) => {
                      console.log("[GenerateDocs-HTML] Blob content as text:");
                      console.log(text);
              ...
              .catch((htmlErr) => {
                console.error("[GenerateDocs-HTML] Error:", htmlErr);
                console.error(
          ...
          <div className="generatedocs-btn-row">
            ...
            {isEditing ? (
              ...
              <button
                ...
                disabled={!apiData || isGenerating || isLoadingHtml || !htmlContent}
              >
