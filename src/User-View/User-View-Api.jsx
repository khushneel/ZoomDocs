...
export const documentAPI = {
  ...
  generate: (docstype, user_inputs, options = {}) => {
    ...
    return api.post(`/documents/types/${encodeURIComponent(docstype)}/generate`, {
      tone_level,
      user_inputs,
      zoomdocs_auth_id,
      zoomdocs_user_id
  ...
  getGenerated: (type, fileName) => {
    ...
    return api.get(`/documents/generated/${encodeURIComponent(type)}/${encodeURIComponent(fileName)}`, {
      responseType: 'blob'
    });
  }
};
